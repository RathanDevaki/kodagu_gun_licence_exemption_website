...
if("ADD_VILLAGE"==$action)
{
    ...
    $village_name=$_POST["village_name"];
     $village_name_ka=$_POST["village_name_ka"];
    $hobli_code =$_POST["hobli_code"];
    $taluk_code=$_POST["taluk_code"];
    $va_circle_code=$_POST["va_circle_code"];
    $sql="INSERT INTO $table(village_code,village_name,village_name_ka,hobli_code,taluk_code,va_circle_code)VALUES('".$village_code."','".$village_name."','".$village_name_ka."','".$hobli_code."','".$taluk_code."','".$va_circle_code."')";
    $result=$conn->query($sql);
    echo "Success";
    $conn->close();
    return;
...
$sql="UPDATE Village SET village_code='".$village_code."',village_name='".$village_name."',village_name_ka='".$village_name_ka."', taluk_code='".$taluk_code."' ,hobli_code = '".$hobli_code."',va_circle_code = '".$va_circle_code."' where sl_no = '".$sl_no."' ";
 $result=$conn->query($sql);
    echo "Success";
    $conn->close();
    return;
